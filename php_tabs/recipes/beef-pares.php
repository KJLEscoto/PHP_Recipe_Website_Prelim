...
<body id="gradient-bg">
  ...
  <div class="md:p-20 p-10 mt-20">
    ...
    <section class="lg:flex block m-auto">
      <img class="shadow-lg w-full h-auto rounded-md mb-10 duration-300 lg:hidden block" src="../../img/beef.jpg"
        alt="beef">
      <img class="shadow-lg w-[700px] h-[450px] rounded-md mb-10 duration-300 hidden lg:block" src="../../img/beef.jpg"
        alt="beef">
      <div class="justify-center text-justify m-auto">
        <h1 class="text-3xl font-bold text-[#a52300] mb-10 text-center tracking-wide hidden lg:block">Beef Pares</h1>
        <hr class="w-3/5 m-auto mb-5 border">
        <p class="text-[#ffede8] lg:text-base xl:text-lg text-base tracking-wider ml-5 duration-300">Beef pares is a
          popular Filipino dish that originated in the streets of Metro Manila.
        ...
        <div class="m-auto justify-center text-center text-gray-300 ml-5 xl:text-sm text-xs duration-300">
          <p class="tracking-widest"><span class="font-semibold">Prep Time: </span>25 minutes
            |
            <span class="font-semibold">Cook Time: </span>2
            hours
          </p>
          <p class="tracking-widest"><span class="font-semibold">Total Time: </span>2 hours : 25
            minutes
            | <span class="font-semibold">Servings: </span>6</p>
        </div>
      </div>
    </section>
    <hr class=" mt-14">
    ...
    <section class="mt-10">
      ...
      <div class="lg:flex block">
        <ul
          ...
          <p class="text-sm mt-5 text-[#a52300] lg:hidden block text-center mb-10">Enjoy your homemade Beef Pares!</p>
          <p class="text-sm mt-5 text-[#a52300] lg:block hidden">Enjoy your homemade Beef Pares!</p>
        </ul>
